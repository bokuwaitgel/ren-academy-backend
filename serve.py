...
@app.post(
    ...
    description=(
        "Upload raw audio as multipart/form-data and save the URL directly into the session's speaking answers.\n\n"
        "part: 1, 2, or 3\n"
...
async def speaking_upload_file(
    ...
    if part == 2:
        ...
        entry = {"question": question, "audio_url": audio_url}
    ...
    await repo.update(session_id, {"answers": session_answers})
